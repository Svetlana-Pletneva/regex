...
# Приводим номера телефонов к виду +7(999)999-99-99 доб.9999
...
for telephone in contacts_list_splited:
    ...
    contacts_list_tel.append(telephone_list)
#print(contacts_list_tel)

fin_list = []
result_list = []


for string in contacts_list_tel:
    i = 2
    for str in fin_list:
...
with open("phonebook.csv", "w") as f:
    ...
    datawriter.writerows(fin_list)   # Вместо contacts_list подставьте свой список
